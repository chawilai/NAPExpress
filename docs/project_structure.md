...
4. กรอก form ผ่าน page.evaluate():
   ...
   ├─ Pre-test: ทำ (Y), PICT, รายบุคคล
   ├─ Post-test: ทำ (Y), ไม่มีคู่
   ├─ STI: ส่งต่อ/ไม่ส่งต่อ + ผลตรวจ (syphilis, CT, NG)
   ├─ เมทาโดน: ไม่ได้รับ
