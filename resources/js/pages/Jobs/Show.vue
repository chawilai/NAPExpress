        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6 font-['Outfit']">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-slate-500">
                    ...
                    on {{ new Date(job.created_at).toLocaleString() }}
                </div>
            </div>

            <div class="grid gap-6 md:grid-cols-3">
                <Card
                    class="border-slate-200 shadow-sm md:col-span-1 dark:border-slate-800"
                >
                    <CardHeader>
                    ...
                    <CardContent class="grid gap-4">
                        ...
                        <div
                            ...
                            class="mt-4 rounded-lg border border-blue-100 bg-blue-50 p-4 dark:border-blue-900/30 dark:bg-blue-900/10"
                        >
                            <div
                                class="mb-2 flex items-center gap-2 text-blue-800 dark:text-blue-300"
                            >
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: `${(job.counts.success / job.counts.total) * 100}%`,
                                    }"
                                ></div>
                            </div>
                        </div>
                ...
                <Card
                    class="border-slate-200 shadow-sm md:col-span-2 dark:border-slate-800"
                >
                    <CardHeader>
                        <CardTitle class="text-lg">Record Logs</CardTitle>
                        <CardDescription
                            >Detailed status of each processed
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left text-sm">
                                ...
                                >
                                    <tr>
                                        <th
                                            class="px-6 py-3 font-semibold text-slate-600 dark:text-slate-400"
                                        >
                                            Row
                                        </th>
                                        <th
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td class="px-6 py-3">
                                            <span
                                                v-if="row.nap_response_code"
                                                class="rounded bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-900 dark:bg-slate-800 dark:text-white"
                                            >
