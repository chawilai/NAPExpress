...
const autoNapCost = computed(() => {
    if (casesPerMonth.value <= 500) {
        return 1990;
    }

    if (casesPerMonth.value <= 1500) {
        return 3990;
    }

    if (casesPerMonth.value <= 3500) {
        return 5990;
    }

    if (casesPerMonth.value <= 8000) {
        return 12990;
    }
...
const roiPercent = computed(() =>
    autoNapCost.value > 0
        ? Math.round((saved.value / autoNapCost.value) * 100)
        : 0,
);
...
const painPoints = [
    {
        ...
        description:
            'พยาบาลหรือเจ้าหน้าที่ต้องนั่งกรอกฟอร์ม NAP ด้วยตัวเอง ทุกเคส',
    },
    {
        title: 'จ้างพนักงานบันทึก 1-2 คน',
        description:
            'ค่าจ้าง 15,000-30,000 บาท/เดือน เฉพาะสำหรับกรอกข้อมูลอย่างเดียว',
    },
    {
...
<template>
    ...
    >
        ...
        >
            ...
            >
                ...
                <div class="hidden items-center gap-6 md:flex">
                    <a
                        href="#features"
                        class="text-sm font-medium text-slate-600 hover:text-teal-600 dark:text-slate-300"
                        >จุดเด่น</a
                    >
                    <a
                        href="#pricing"
        ...
        <main>
            <!-- Hero Section -->
            <section
                class="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-28"
            >
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div class="flex flex-col items-start gap-6">
                            ...
                            <h1
                                class="text-4xl font-bold tracking-tight text-balance text-slate-900 sm:text-5xl lg:text-6xl dark:text-white"
                            >
                                บันทึก NAP
                                <span
                                    class="bg-linear-to-r from-teal-500 to-blue-600 bg-clip-text text-transparent"
                                >
                                    อัตโนมัติ
                                </span>
                                <br />เร็วกว่า 10 เท่า
                            ...
                            <p
                                class="text-lg text-pretty text-slate-600 dark:text-slate-400"
                            >
                                ลดเวลาบันทึกจาก
                                <strong>3 นาที เหลือ 15 วินาที/เคส</strong> —
                                ใช้แล้วโดยคลินิก HIV
                                <strong>17 แห่ง</strong>ทั่วประเทศ ในเครือข่าย
                                สปสช.
                            </p>
                        ...
                        <div class="relative">
                            <div
                                class="absolute -inset-1 rounded-3xl bg-linear-to-r from-teal-500 to-blue-600 opacity-20 blur-3xl lg:opacity-30"
                            ></div>
                            <div
                                class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl dark:border-slate-800 dark:bg-slate-900"
                            >
                                <img
                                    src="/assets/hero.png"
            ...
            <!-- Social Proof / Stats -->
            <section
                class="border-y border-slate-200 bg-white py-12 dark:border-slate-800 dark:bg-slate-900/50"
            >
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <p
                        class="mb-8 text-center text-sm font-medium text-slate-500 dark:text-slate-400"
                    >
                    ...
                    <div class="grid grid-cols-2 gap-6 md:grid-cols-4">
                        ...
                        >
                            <component
                                :is="stat.icon"
                                class="mb-2 h-8 w-8 text-teal-500"
                            />
                            <div
            ...
            <section id="features" class="bg-white py-20 dark:bg-slate-900/50">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mb-16 flex flex-col items-center text-center">
                        ...
                        <div
                            class="mt-4 h-1.5 w-20 rounded-full bg-teal-500"
                        ></div>
                        <p
                            class="mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400"
                        >
            ...
            <section id="roi" class="py-20">
                <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <Card
                        class="border-teal-200 shadow-xl dark:border-teal-900"
                    >
                        <CardContent class="p-8">
                            <div class="mb-6">
                                ...
                                >
                                    จำนวนเคส/เดือน:
                                    <span
                                        class="ml-2 text-2xl font-bold text-teal-600"
                                    >
                                ...
                                />
                                <div
                                    class="mt-1 flex justify-between text-xs text-slate-500"
                                >
                                    <span>100</span>
                                    <span>6,000+</span>
                                </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-3">
                                <div
                                    class="rounded-xl bg-rose-50 p-5 dark:bg-rose-950/20"
                                >
                                    <div
                                    ...
                                    <div
                                        class="mt-1 text-2xl font-bold text-rose-600 dark:text-rose-300"
                                    >
                                ...
                                <div
                                    class="rounded-xl bg-blue-50 p-5 dark:bg-blue-950/20"
                                >
                                    <div
                                    ...
                                    <div
                                        class="mt-1 text-2xl font-bold text-blue-600 dark:text-blue-300"
                                    >
                                        ฿{{ autoNapCost.toLocaleString() }}
                                    </div>
                                    <div class="mt-1 text-xs text-blue-500">
                                        List price (ไม่รวม Founding discount)
                                    </div>
                                </div>
                                <div
                                    class="rounded-xl bg-teal-50 p-5 dark:bg-teal-950/20"
                                >
                                    <div
                                        class="text-xs font-medium text-teal-700 dark:text-teal-400"
                                    >
                                        ประหยัด/เดือน
                                    </div>
                                    <div
                                        class="mt-1 text-2xl font-bold text-teal-600 dark:text-teal-300"
                                    >
                                        ฿{{ saved.toLocaleString() }}
                                    </div>
                                    <div class="mt-1 text-xs text-teal-500">
                                        ROI {{ roiPercent }}%
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                class="mt-6 rounded-xl bg-linear-to-r from-teal-500 to-blue-600 p-5 text-center text-white"
                            >
            ...
            <section id="pricing" class="bg-white py-20 dark:bg-slate-900/50">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mb-12 text-center">
                        <Badge
                            variant="outline"
                            class="mb-4 border-teal-200 bg-teal-50 text-teal-700 dark:border-teal-900 dark:bg-teal-950/20 dark:text-teal-400"
                        >
                            <Sparkles class="mr-1 h-3.5 w-3.5" />
                        ...
                        <div
                            class="mt-6 inline-flex items-center gap-2 rounded-full border border-teal-200 bg-teal-50 px-4 py-2 text-sm text-teal-700 dark:border-teal-900 dark:bg-teal-950/20 dark:text-teal-400"
                        >
                            <CheckCircle2 class="h-4 w-4" />
                            <span>
                                <strong>1 เคส = 1 ผู้รับบริการ</strong> บันทึก
                                form ไหนก็ได้ (RR / VCT / Lab / Result / PrEP)
                                ไม่คิดเพิ่ม
                            </span>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <CardHeader>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div
                                        class="mt-1 text-xs font-medium text-teal-600 dark:text-teal-400"
                                    >
                                        Founding price (ล็อค 12 เดือน)
                                    </div>
                                </div>
                                <div
                                    class="mt-2 text-sm font-medium text-slate-600 dark:text-slate-400"
                                >
                                    👥 {{ tier.quota }}
                                </div>
                                <div
                    ...
                    >
                        💡 จ่ายล่วงหน้า 3 เดือน = ฟรี 1 เดือน • 12 เดือน = ฟรี 3
                        เดือน<br />
                        🎁 <strong>ไม่จำกัด form</strong> — บันทึก RR, VCT, Lab,
                        Result ต่อเคสเดิมได้ไม่คิดเพิ่ม<br />
                    ...
                    <div class="grid gap-6 md:grid-cols-3">
                        ...
                        >
                            <CardContent class="p-6">
                                ...
                                <p
                                    class="mb-4 text-slate-700 dark:text-slate-300"
                                >
                                    "{{ t.quote }}"
                                </p>
                                <div
            ...
            <section id="faq" class="bg-white py-20 dark:bg-slate-900/50">
                <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    <h2
                        class="mb-12 text-center text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl dark:text-white"
                    >
                        คำถามที่พบบ่อย
                    </h2>
                    <div class="space-y-6">
                        <div>
                            ...
                            <p class="text-slate-600 dark:text-slate-400">
                                AutoNAP เป็น Robotic Process Automation (RPA)
                                แบบเดียวกับที่ธนาคารและบริษัทบัญชีใช้
                                ระบบทำงานเป็น "ผู้ช่วยเสมือน" ของเจ้าหน้าที่ —
                                Login ผ่าน ThaID ของผู้ใช้เอง หรือ credentials
                                ของคลินิก
                                แล้วกรอกฟอร์มในสิ่งที่เจ้าหน้าที่ทำเองได้อยู่แล้ว
                                เพียงแต่ทำเร็วและต่อเนื่องกว่า
                            </p>
                        </div>
                        <div>
                            <h3
                            ...
                            <p class="text-slate-600 dark:text-slate-400">
                                <strong
                                    >ปลอดภัยมาก
                                    เพราะเราไม่เก็บข้อมูลผู้ป่วยเลย</strong
                                >
                                — CSV ที่คุณ upload ถูกประมวลผลแล้วลบทันที
                                เก็บไว้แค่ 4 ตัวท้ายของเลขบัตร กับรหัส NAP เพื่อ
                                audit เท่านั้น (90 วันแล้วลบอัตโนมัติ)
                            </p>
                        </div>
                        <div>
                            <h3
                                class="mb-2 text-lg font-semibold text-slate-900 dark:text-white"
                            >
                                1 เคสนับยังไง? ถ้าบันทึกหลาย form
                                ต่อผู้รับบริการคนเดียวกัน?
                            </h3>
                            <p class="text-slate-600 dark:text-slate-400">
                                <strong
                                    >1 เคส = 1 ผู้รับบริการ (patient
                                    visit)</strong
                                >
                                ไม่ว่าคุณจะบันทึก RR อย่างเดียว, RR+VCT, หรือ
                                RR+VCT+Lab+Result ครบวงจร
                                <strong>นับเป็น 1 เคสเท่านั้น</strong>
                                ไม่คิดเพิ่มตาม form <br /><br />
                                เพิ่มการบันทึก Result ทีหลัง (เช่น รอผล lab)
                                ก็ไม่นับซ้ำ — ถือเป็นการ update ของเคสเดิม
                                คุณได้ flexibility
                                เต็มในการบันทึกตามจังหวะงานจริง
                            </p>
                        </div>
                        <div>
                            <h3
                            ...
                            <p class="text-slate-600 dark:text-slate-400">
                                AutoNAP ออกแบบเป็น
                                <strong>input-agnostic</strong> —
                                ใช้ได้โดยไม่ต้องเปลี่ยนระบบเดิมของคุณ รองรับ 5
                                ช่องทาง: <strong>CSV/Excel upload</strong>, Web
                                form บน AutoNAP, Google Sheets sync, Open
                                API/Webhook และ Custom integration <br /><br />
                                Integration พร้อมใช้งาน:
                                <strong>ACTSE Clinic</strong>
                                (ระบบจัดการคลินิกในเครือ) และ CAREMAT
                                ส่วนระบบอื่นสามารถเริ่มจาก CSV upload ได้ทันที
                                ไม่ต้องรอ IT ของลูกค้าเซ็ตอัพ
                            </p>
                        </div>
                        <div>
                            <h3
                            ...
                            <p class="text-slate-600 dark:text-slate-400">
                                ...
                                ถ้าอยู่ในช่วง Founding 50 (ล็อคราคา 12 เดือน)
                                ยกเลิกได้แต่ไม่คืนเงินที่จ่ายล่วงหน้า
                            </p>
                        </div>
                        <div>
                            <h3
                            ...
                            <p class="text-slate-600 dark:text-slate-400">
                                มีครับ — template ตาม PDPA พร้อมให้ทนายของคลินิก
                                review ก่อนเซ็น สามารถขอได้ฟรีหลังสมัคร
                            </p>
                        </div>
                    </div>
                </div>
            ...
            >
                <div class="absolute inset-0 opacity-10 blur-3xl">
                    <div
                        class="absolute -top-1/2 -left-1/4 h-full w-full bg-teal-500"
                    ></div>
                </div>
                <div
                ...
                >
                    ...
                    <p class="mx-auto mt-6 max-w-2xl text-lg text-slate-300">
                        เริ่มใช้งานฟรี 30 วัน ไม่ต้องใส่บัตรเครดิต — ล็อคราคา
                        Founding 50% off ตลอด 12 เดือน
                    </p>
                    <div
